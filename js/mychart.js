...
new Chart(document.getElementById("bar-chart"), {
  ...
  data: {
    ...
    '🇫🇮 Finlândia', '🇩🇰 Dinamarca', '🇧🇬 Bulgária', '🇸🇰 Eslóvaquia', '🇱🇹 Lituânia','🇪🇪 Estónia', '🇨🇾 Chipre','🇲🇹 Malta', '🇱🇺 Luxembrugo'],
    datasets: [
      {
        data: [179242169, 171475894, 130803657, 128100932,43912615,40093480,33895930,
        30736850, 28718094,25866422,21247150,18648937, 17559915,13116056,12815999,
        11967117, 7966674, 7799680, 5487207,3620390, 3591495,3177161, 2808808, 1982579, 
        1139037],
